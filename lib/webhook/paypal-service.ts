...
class PayPalService {
  ...
  private constructor() {
    ...
    this.isProduction = process.env.NEXT_PUBLIC_NODE_ENV === "production";
  ...
  private get baseUrl(): string {
    console.log(this.isProduction, this.clientId, this.clientSecret, process.env.PAYPAL_WEBHOOK_ID);
